...
TILES = dict(
    category="tiles", unit="pieces", quantity=40, condition="good", route="resell", source_type="business_surplus",
...
def test_brand_second_rules():
    hoodie = dict(
        category="clothing", unit="pieces", quantity=10, condition="new", route="resell", source_type="brand_second",
...
def test_laptop_must_be_wiped_before_resale():
    laptop = dict(category="electronics", unit="pieces", quantity=1, condition="good", route="resell",
...
def test_food_time_window():
    now = utcnow()
    food = dict(category="food_cooked", unit="plates", quantity=40, condition="new", route="donate",

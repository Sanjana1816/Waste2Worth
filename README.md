...
| Order tracking map | `app/services/tracking.py` | `pages/Track.jsx`, `components/TrackMap.jsx` |
| Defect heatmap | `app/services/vision.py` (`inspect`) | `components/DefectMap.jsx` |
